...
class ContextTab(QWidget):
    ...
    def _build_proactive_panel(self) -> QWidget:
        ...
        cv.setFieldGrowthPolicy(QFormLayout.AllNonFixedFieldGrow)
        ...
        pv.setFieldGrowthPolicy(QFormLayout.AllNonFixedFieldGrow)
        self.profile_hobbies = QLineEdit()
        self.profile_hobbies.setPlaceholderText(t("ctx_placeholder_hobbies"))
        self.profile_hobbies.setMinimumWidth(300)
        ...
        self.profile_interests.setMinimumWidth(300)
        ...
        self.profile_learning.setMinimumWidth(300)
        ...
        self.profile_work.setMinimumWidth(300)
        ...
        self.profile_keywords.setMinimumWidth(300)
